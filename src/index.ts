...
import type { Formatter, Options } from "./types";
...
async function generateTypes({
  ...
  formatter,
  pathToFormatterConfig,
}: { names: string[]; outputPath: string } & Pick<Options, "formatter" | "pathToFormatterConfig">) {
  const output = [
...
export const unpluginFactory: UnpluginFactory<Options | Options[]> = (maybeConfigs) => {
